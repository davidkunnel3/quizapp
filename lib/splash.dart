...
class _SplashState extends State<Splash> {
  ...
  void initState(){
    super.initState();
    Timer(Duration(seconds: 4), () {Navigator.push(context, MaterialPageRoute(builder: (context) => Question()
    ));
    });
